...
<div class="bgimg w3-display-container w3-text-white">
    ...
    <form action="${pageContext.request.contextPath}/fillMultipleBlanksSubmitted" method="post">
        <label for = "choiceCount">Enter number of blanks: </label>
        <input type="number" name="choiceCount" required placeholder="2-7" id = "choiceCount" min = "2" max = "7"/><br>
